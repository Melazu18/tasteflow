    ...
    <section className="container-page py-12">
      <div className="premium-shell flex flex-col justify-between gap-6 p-7 sm:p-10 md:flex-row md:items-end">
        <div>
          ...
          <h1 className="section-title mt-3">Business dashboard</h1>
          <p className="section-copy mt-4">Manage profile, menus, events, offers, campaigns, analytics, subscriptions, and map visibility.</p>
        </div>
