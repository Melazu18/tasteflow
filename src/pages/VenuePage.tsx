  ...
  return (
    <section className="container-page py-12">
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_380px]">
        <div><h2 className="text-2xl font-semibold tracking-[-0.04em]">Published menu</h2><div className="mt-5 grid gap-4">{items.length ? items.map(i=><MenuCard key={i.id} item={i} showDetails={false}/>) : <Card><CardTitle>No menu items yet</CardTitle><CardText>This business can publish multilingual menus from the dashboard.</CardText></Card>}</div></div>
